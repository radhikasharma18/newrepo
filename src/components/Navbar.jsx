        ...
        <div className='group relative'>
          ...
          <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
            <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded'>
              ...
              <p className='cursor-pointer hover:text-block'>Orders</p>
...
<img src={cart} className='w-5 min-w-5'/>
<p className='absolute right-[5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>10</p>
</Link>
<img onClick ={()=>setVisible(true)}src={menu} className='w-5 cursor-pointer sm:hidden ' alt=''/>

       </div>
       <div className={`absolute top-0 rigth-0 bottom-0 overflow-hidden bg-white transition-all ${visible?'w-full':'w-0'}`}>
